...
public class OllamaController implements IAiService {
     ...
     * 同步生成AI回复
     * 
     * 使用指定的Ollama模型生成对用户消息的回复
     * 
     * @param model Ollama模型名称，如 "deepseek-r1:1.5b"
     * @param message 用户输入的消息
     * @return AI生成的回复
     * 
     * @example http://localhost:8090/api/v1/ollama/generate?model=deepseek-r1:1.5b&message=1+1
     */
     ...
     * 流式生成AI回复
     * 
     * 使用指定的Ollama模型流式生成对用户消息的回复
     * 
     * @param model Ollama模型名称
     * @param message 用户输入的消息
     * @return 流式AI回复
     * 
     * @example http://localhost:8090/api/v1/ollama/generate_stream?model=deepseek-r1:1.5b&message=hi
     */
